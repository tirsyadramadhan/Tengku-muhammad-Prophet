        ...
        <div class="card invoice-preview-card">
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    @php
                    // Pembayaran tunggal per invoice (hasOne)
                        ...
                        <table class="table table-sm text-nowrap mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center no-print">Bukti</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($invoice->payment)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted">
                                            {{ $payment->input_user->user_name ?? 'Pengguna #' . $payment->input_by }}<br>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        @elseif($invoice->status_invoice == 0)
                ...
                @endphp
                <div class="mb-3">
                    <label class="form-label text-muted">Progres Pembayaran</label>
                    <div class="d-flex justify-content-between mb-1">
                        <small>Rp {{ number_format($totalPaid, 2) }} dibayar</small>
