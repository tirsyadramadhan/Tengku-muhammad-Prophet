  ...
  <div class="col-xl-8 col-lg-10 mx-auto">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form
          data-method="PUT"
          id="incomingPoForm" action="{{ route('po.update', $po->po_id) }}" method="POST">
          <div class="mb-4">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4">
              ...
              <input value="{{ $po->qty }}" maxlength="3" type="text" name="qty" id="qty" class="form-control live-validate numeric-only" min="1" placeholder="Contoh: 10">
            </div>
