                    ...
                    <form id="investasiForm" action="{{ route('investments.store') }}" method="POST">
                        ...
                        <div class="mb-4 input-group-wrapper">
                            ...
                            <div id="setor_manual_container" class="hidden-input">
                                <input type="number" class="form-control manual-input" name="manual_setor_awal" value="0" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 input-group-wrapper">
                            ...
                            <div id="po_baru_manual_container" class="hidden-input">
                                <input type="number" class="form-control manual-input" name="manual_po_baru" value="0" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 input-group-wrapper">
                            ...
                            <div id="margin_manual_container" class="hidden-input">
                                <input type="number" class="form-control manual-input" name="manual_total_margin" value="0" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control calc-trigger" name="pencairan_modal" id="pencairan_modal" value="0">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Penarikan</label>
                                <div class="input-group">
                                    <button class="btn btn-outline-secondary toggle-simple" type="button" onclick="flipValue('#penarikan')">(-)</button>
                                    <input type="number" step="0.01" class="form-control calc-trigger" name="penarikan" id="penarikan" value="0">
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        function recalculate() {
            ...
            var penarikan = parseFloat($('#penarikan').val()) || 0;
