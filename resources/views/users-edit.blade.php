...
<div class="row">
    <div class="col-xl-8 col-lg-10 mx-auto">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="needs-validation" id="create-users" action="{{ route('users.update', $user->user_id) }}" method="POST" novalidate autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label class="form-label fw-bold">Nama Pengguna</label>
                        <input value="{{ $user->user_name }}" type="text" name="user_name" class="form-control live-validate" placeholder="Username">
                    ...
                    <div class="mb-4">
                        ...
                        <input value="{{ $user->email }}" type="text" name="email" class="form-control live-validate" placeholder="Email">
                        <div class="valid-feedback">Sudah Benar</div>
