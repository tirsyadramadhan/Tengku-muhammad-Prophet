...
<script>
    $(document).ready(function() {
        ...
        function validateField(element) {
            ...
            if (fieldId === 'po_id') {
                isValid = value !== '';
                setValidity(isValid, 'Silakan pilih PO.');
            }
            // Quantity
            ...
            // Date
                ...
                isValid = value !== '';
                setValidity(isValid, 'Tanggal pengiriman wajib diisi.');
            }
        ...
        $('#deliveryForm').on('submit', function(e) {
            ...
            if (document.getElementById('qty_warning').style.display === 'block') {
                Swal.fire({
                    ...
                    text: 'Anda tidak dapat mengirim lebih dari sisa jumlah PO.'
                });
                return;
            }

            let $btn = $('#submit_btn');
            let originalText = $btn.text(); // "Simpan Pengiriman"
