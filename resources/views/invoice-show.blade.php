    ...
    <div class="card invoice-preview-card">
      <div class="card-body">
        ...
        <div class="card-body">
          ...
          // 2. Direct access (no sum needed for single payment)
          ...
          @else
          {{-- Show payment details here since it is paid --}}
          <p>Paid on: {{ \Carbon\Carbon::parse($invoice->payment->payment_date)->format('d M Y') }}</p>
          @endif
    ...
    <div class="card mb-4">
      <div class="card-body">
        <button class="btn btn-primary d-grid w-100 mb-4" data-bs-toggle="offcanvas" data-bs-target="#sendInvoiceOffcanvas">
          <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="ri-send-plane-fill me-2"></i>Send Invoice</span>
        </button>
