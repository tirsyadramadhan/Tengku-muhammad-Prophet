...
<style>
    ...
    /* --- Perfect DataTable Styling (Materio Style) --- */
    .card-datatable {
        padding: 0;
    }
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header d-flex justify-content-between align-items-center bg-white py-4 px-4 border-bottom-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 fw-bold text-dark">Data Invoice</h5>
                    <small class="text-muted">Manage your billing and payments</small>
                </div>
            </div>
            <a href="{{ route('invoice.create') }}" class="btn btn-primary shadow-sm">
                <i class="ri-add-line me-1"></i> Tambahkan Invoice
            </a>
        </div>
...
<script>
    $(document).ready(function() {
        // FIX: Removed $.noConflict(); which causes issues in this context
        $.noConflict();
        var table = $('#invoice-table').DataTable({
            ...
            // FIX: Set a default sort (e.g., by Due Date ascending, or Invoice Number)
            // Column 4 is "Due In"
            order: [
                [4, 'asc']
            ],
