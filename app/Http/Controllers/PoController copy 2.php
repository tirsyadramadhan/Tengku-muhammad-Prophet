        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->editColumn('detail_po', function ($row) {
                    ...
                    $relative = $tglPo->toIndonesianRelative();
                    $formated = $tglPo->format('d M Y');
                    $qty_formatted = number_format((int) $row->qty, 0, ',', '.');
                    ...
                    return <<<HTML
                        <div class="po-card shadow-lg">
                            ...
                            <div class="po-card-header">
                                ...
                                <div>
                                    <div style="font-size:0.6rem;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:#94a3b8;">No. PO</div>
                                    <div class="po-number">{$row->no_po}</div>
                                </div>
                            </div>
                            ...
                            <div class="po-card-body">
                                ...
                                <div class="po-row">
                                    ...
                                    <div class="po-row-content">
                                        <span class="po-row-label">Nama Barang</span>
                                        <span class="po-row-value">{$row->nama_barang}</span>
                                    </div>
                                </div>
                                ...
                                <div class="po-row">
                                    ...
                                    <div class="po-row-content">
                                        <span class="po-row-label">Kuantitas</span>
                                        <span class="po-row-value">{$qty_formatted} Unit</span>
                                    </div>
                                </div>
                ...
                ->editColumn('price_references', function ($row) {
                    ...
                    // Pre-compute before heredoc
                    $totalFmt   = $fmt($total);
                    $hargaFmt   = $fmt($harga);
                    $modalFmt   = $fmt($modal);
                    $qtyFmt     = number_format($qty, 0, ',', '.');
                    $modalUnit  = $fmt($qty > 0 ? $modal / $qty : 0);

                    $qtySubHarga = $qty > 0
                        ? "<span class=\"prc-row-sub\"><i class=\"ri-stack-line me-1\"></i>{$qtyFmt} Unit</span>"
                        : '';

                    $qtySubModal = $qty > 0
                        ? "<span class=\"prc-row-sub\"><i class=\"ri-divide-line me-1\"></i>{$modalUnit} / unit</span>"
                        : '';
                    ...
                    return <<<HTML
                        <div class="prc-card shadow-lg">
                            ...
                            <div class="prc-hero">
                                ...
                                <div class="d-flex flex-column gap-0">
                                    <span class="prc-hero-label">Total Harga PO</span>
                                    <span class="prc-hero-value">{$totalFmt}</span>
                                </div>
                            </div>
                            ...
                            <div class="prc-card-body">
                                ...
                                <div class="prc-row">
                                    ...
                                    <div class="prc-row-content">
                                        <span class="prc-row-label">Harga Per Unit</span>
                                        <span class="prc-row-value">{$hargaFmt}</span>
                                        {$qtySubHarga}
                                    </div>
                                </div>
                                ...
                                <div class="prc-row">
                                    ...
                                    <div class="prc-row-content">
                                        <span class="prc-row-label">Modal PO</span>
                                        <span class="prc-row-value">{$modalFmt}</span>
                                        {$qtySubModal}
                                    </div>
                                </div>
                            </div>
                ...
                ->editColumn('margin_references', function ($row) {
                    ...
                    $marginFmt      = $fmt($margin);
                    $marginUnitFmt  = $fmt($marginUnit);
                    $tambahanFmt    = $fmt($tambahanMargin);
                    $totalExtraFmt  = $fmt($totalWithExtra);
                    $qtyFmt         = number_format($qty, 0, ',', '.');

                    $qtySubMargin = $qty > 0
                        ? "<span class=\"mrg-row-sub\"><i class=\"ri-stack-line me-1\"></i>{$qtyFmt} Unit</span>"
                        : '';

                    $extraRowSub = $hasExtra
                        ? "<span class=\"mrg-row-sub\" style=\"color:{$extraColor};\">+{$extraPct}% dari margin dasar</span>"
                        : '<span class="mrg-row-sub">Tidak ada tambahan</span>';

                    $totalMarginSub = $hasExtra
                        ? '<span class="mrg-row-sub">Margin + Tambahan</span>'
                        : '<span class="mrg-row-sub" style="color:#94a3b8;">Sama dengan margin dasar</span>';
                    ...
                    return <<<HTML
                        <div class="mrg-card">
                            ...
                            <!-- Hero: Total Margin PO -->
                            <div class="mrg-hero">
                                <div class="mrg-hero-icon" style="color:{$healthColor};">
                                    <i class="ri-funds-line"></i>
                                </div>
                                <div class="d-flex flex-column gap-0" style="flex:1;">
                                    <span class="mrg-hero-label">Total Margin PO</span>
                                    <span class="mrg-hero-value" style="color:{$healthColor};">{$marginFmt}</span>
                                </div>
                                <span class="mrg-pct-pill" style="background:{$healthColor}22;color:{$healthColor};border-color:{$healthColor}55;">
                                    {$marginPct}%
                                </span>
                            </div>
                            ...
                            <div class="mrg-progress-wrap">
                                <div class="mrg-progress-track">
                                    <div class="mrg-progress-fill" style="width:{$barWidth}%;background:{$healthBar};"></div>
                                </div>
                                <div class="mrg-progress-labels">
                                    <span style="font-size:0.58rem;font-weight:600;color:#475569;">0%</span>
                                    <span style="font-size:0.58rem;font-weight:700;color:{$healthColor};">{$healthLabel}</span>
                                    <span style="font-size:0.58rem;font-weight:600;color:#475569;">100%</span>
                                </div>
                            </div>
                            ...
                            <div class="mrg-card-body">
                                ...
                                <div class="mrg-row">
                                    ...
                                    <div class="mrg-row-content">
                                        <span class="mrg-row-label">Margin Per Unit</span>
                                        <span class="mrg-row-value">{$marginUnitFmt}</span>
                                        {$qtySubMargin}
                                    </div>
                                    <span class="mrg-badge" style="background:#7c3aed18;color:#7c3aed;border-color:#7c3aed40;">
                                        {$marginUnitPct}%
                                ...
                                <div class="mrg-row">
                                    ...
                                    <div class="mrg-row-content">
                                        <span class="mrg-row-label">Total Margin Gabungan</span>
                                        <span class="mrg-row-value" style="color:#d97706;">{$totalExtraFmt}</span>
                                        {$totalMarginSub}
                                    </div>
                                </div>
                            ...
                            <!-- Footer: Health Indicator -->
                            <div class="mrg-footer" style="background:{$healthBg};border-color:{$healthBorder};">
                                <span class="mrg-chip" style="background:{$healthColor}18;color:{$healthColor};border-color:{$healthColor}40;">
                                    <i class="{$healthIcon}" style="font-size:0.85rem;"></i>
                                    {$healthLabel}
                                </span>
                                <span style="font-size:0.68rem;font-weight:800;color:{$healthColor};">
                                    {$marginPct}% dari modal
                                </span>
                            </div>
                        </div>
